[![Stories in Ready](https://badge.waffle.io/tjmonsi/nice-v1.png?label=ready&title=Ready)](https://waffle.io/tjmonsi/nice-v1)
# 
...
* **src/** is where your application-specific root-element will go
    * **project-nice-app.html** is the main core element called in the index.html that
        renders the pages.
